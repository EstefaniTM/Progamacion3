...
export declare const ContenidoSchema: import("mongoose").Schema<Contenido, import("mongoose").Model<Contenido, any, any, any, Document<unknown, any, Contenido, any> & Contenido & Required<{
    ...
    __v: number;
}, any>, {}, {}, {}, {}, import("mongoose").DefaultSchemaOptions, Contenido, Document<unknown, {}, import("mongoose").FlatRecord<Contenido>, {}> & import("mongoose").FlatRecord<Contenido> & Required<{
    _id: unknown;
}> & {
    __v: number;
}>;
